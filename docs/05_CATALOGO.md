...
admin → menu · encargado → encargado · residente → residente · jefe → jefe · capataz1-5 → reporte-capataz · chequeadora1-3 → reporte-chequeadora. (Todas las claves viven en la hoja `USUARIOS`; `capataz1-5`/`chequeadora1-3` son los usuarios de la etapa V1.)
