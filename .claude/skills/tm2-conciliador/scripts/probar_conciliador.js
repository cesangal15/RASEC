...
ok('4 reclamadas', r.reclamadas === 4, r.reclamadas);
ok('1 ENCONTRADA', r.conteo.ENCONTRADA === 1, r.conteo);
...
ok('al acta solo la encontrada', r.alActa === 1, r.alActa);
...
ok('sesión importable por la herramienta (tipo conciliador_sesion)', ses.tipo === 'conciliador_sesion' && ses.corte && ses.corte.reclamos.length === 4);
