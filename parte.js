...
function pintarPicker(){
  ...
  if(pickerCtx.tipo==='operador'){
    ...
    html=items.map(o=>'<button type="button" class="picker-item'+(o===operador?' sel':'')+'" data-on-click="elegir('+esc(JSON.stringify(o))+')">'+esc(o)+'</button>').join('');
